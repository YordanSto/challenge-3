...
function onSuccess(response) {
	...
	TweenMax.from("#location", 1, {ease:Expo.easeOut, left:800, opacity:0, scale:0});
	TweenMax.from("#suitable", 1, {ease:Expo.easeOut, left:800, opacity:0, scale:0, delay:0.3});
	TweenMax.from("#temperature", 1, {ease:Expo.easeOut, right:800, opacity:0, scale:0, delay:0.6});
	TweenMax.from("#wind", 1, {ease:Expo.easeOut, left:800, opacity:0, scale:0, delay:0.9});
	TweenMax.from("#clouds", 1, {ease:Expo.easeOut, left:800, opacity:0, scale:0, delay:1.2});
